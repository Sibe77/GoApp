...
myApp.controller('appController', ['$scope', function($scope) {
  ...
  $scope.search = function(filter) {
    ...
    // Analytics
    if ($scope.noResults) {
      ga_storage._trackPageview('mobileSearch?searchText=' + filter.toLowerCase() + ' (Not Found)', 'No Results Mobile Search');
    } else {
      ga_storage._trackPageview('mobileSearch?searchText=' + filter.toLowerCase(), 'Mobile Search');
    }
  }
